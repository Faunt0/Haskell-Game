...
bitmaploadin = do  
    ...
    return (Data.Map.fromList ([("title",title),("ship",s),("pea",pea),("swarm", swarm),("worm", worm),("failed",failed),("cloud",cloud),("moon",moon),("mountain",mountain),("rocket",rocket)]++splosions2))
