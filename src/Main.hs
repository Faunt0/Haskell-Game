...
bitmaploadin = do  
    ...
    turret <- loadBMP "bitmaps/turret.bmp"
    ...
    title <- loadBMP "bitmaps/title.bmp"
    ...
    return (Data.Map.fromList ([("title",title),("ship",s),("pea",pea),("swarm", swarm),("worm", worm),("failed",failed),("cloud",cloud),("moon",moon),("mountain",mountain),("rocket",rocket),("turret",turret)]++splosions2))
